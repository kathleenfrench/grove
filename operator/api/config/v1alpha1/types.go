...
var (
	...
	SupportedSchedulerNames = []SchedulerName{SchedulerNameKai, SchedulerNameKube, SchedulerNameLPX}
)
...
type SchedulerConfiguration struct {
	...
	// Valid profile names: "default-scheduler", "kai-scheduler", "lpx-scheduler".
...
type SchedulerProfile struct {
	...
	// +kubebuilder:validation:Enum=kai-scheduler;default-scheduler;lpx-scheduler
